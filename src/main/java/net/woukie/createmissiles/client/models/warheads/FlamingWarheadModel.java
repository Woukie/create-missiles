...
public class FlamingWarheadModel implements MissilePartModel {
	...
	public ResourceLocation getTexture(int stage) {
		return ResourceLocation.fromNamespaceAndPath(CreateMissiles.MOD_ID,"textures/entity/flaming_warhead.png");
	}
