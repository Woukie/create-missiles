...
public class Menus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<ControlPanelMenu>> CONTROL_PANEL = MENUS.register("control_panel", () -> new MenuType<>(ControlPanelMenu::new, FeatureFlags.VANILLA_SET));

    public static final DeferredHolder<MenuType<?>, MenuType<AssemblyPanelMenu>> ASSEMBLY_PANEL = MENUS.register(
            "assembly_panel",
            () -> new MenuType<>(AssemblyPanelMenu::new, FeatureFlags.VANILLA_SET)
    );

    public static final DeferredHolder<MenuType<?>, MenuType<NavigationPanelMenu>> NAVIGATION_PANEL = MENUS.register(
            "navigation_panel",
