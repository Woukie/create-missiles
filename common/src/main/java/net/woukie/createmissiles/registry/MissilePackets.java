...
public class MissilePackets {
    ...
    public static final NetworkChannel CONTROLLER_LAUNCH = NetworkChannel.create(new ResourceLocation(CreateMissiles.MOD_ID, "launch_controller"));
    ...
    public static void init() {
        ...
        CONTROLLER_LAUNCH.register(ControllerLaunchMessage.class, ControllerLaunchMessage::encode, ControllerLaunchMessage::new, ControllerLaunchMessage::apply);
    }
}
