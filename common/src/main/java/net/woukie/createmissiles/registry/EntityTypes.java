...
public class EntityTypes {
    ...
    public static final RegistrySupplier<EntityType<MissileEntity>> MISSILE = ENTITY_TYPES.register(
            "missile_entity",
            () -> EntityType.Builder.of(MissileEntity::new, MobCategory.MISC).noSummon().fireImmune().sized(1.5F, 5F).clientTrackingRange(32).build(new ResourceLocation(CreateMissiles.MOD_ID, "missile_entity").toString())
    );
    ...
    public static final RegistrySupplier<EntityType<GuardianballEntity>> GUARDIANBALL = ENTITY_TYPES.register(
            "guardianball",
            () -> EntityType.Builder.of(GuardianballEntity::new, MobCategory.MISC).sized(0.5f, 0.5f).build(new ResourceLocation(CreateMissiles.MOD_ID, "guardianball").toString())
    );
    ...
    public static final RegistrySupplier<EntityType<WitheredballEntity>> WITHEREDBALL = ENTITY_TYPES.register(
            "witheredball",
            () -> EntityType.Builder.of(WitheredballEntity::new, MobCategory.MISC).sized(0.5f, 0.5f).build(new ResourceLocation(CreateMissiles.MOD_ID, "witheredball").toString())
    );
