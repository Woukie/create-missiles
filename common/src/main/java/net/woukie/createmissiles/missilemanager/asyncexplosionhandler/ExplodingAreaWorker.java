...
public class ExplodingAreaWorker implements Runnable {
    ...
    public void run() {
        ...
        for (BlockPos blockPos : positions) {
            ...
            if (distance > this.power / 0.315) continue;
            ...
            traverseSupercover(origin, realBlockPos, pos -> {
                ...
                if (this.power - ((HARDNESS_MULTIPLIER * averageHardness + HARDNESS_OFFSET) * distance) - (HARDNESS_MULTIPLIER * blockHardness + HARDNESS_OFFSET) <= 0) return true;
